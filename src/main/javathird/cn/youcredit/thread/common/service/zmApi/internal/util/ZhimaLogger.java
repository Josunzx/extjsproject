...
public class ZhimaLogger {
    ...
    public static String getIp() {
        if (ZhimaLogger.ip == null) {
            try {
                ZhimaLogger.ip = InetAddress.getLocalHost().getHostAddress();
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        return ZhimaLogger.ip;
    }
    ...
    public static void logCommError(Exception e, HttpURLConnection conn,
        ...
        if (!ZhimaLogger.needEnableLogger) {
            return;
        }
        String contentString = null;
        try {
            contentString = new String(content, "UTF-8");
            ZhimaLogger.logCommError(e, conn, appKey, method, contentString);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    }
    ...
    public static void logCommError(Exception e, String url, String appKey,
        ...
        try {
            contentString = new String(content, "UTF-8");
            ZhimaLogger.logCommError(e, url, appKey, method, contentString);
    ...
    public static void logCommError(Exception e, HttpURLConnection conn,
        ...
        ZhimaLogger._logCommError(e, conn, null, appKey, method, params);
    }
    ...
    public static void logCommError(Exception e, String url, String appKey,
        ...
        ZhimaLogger._logCommError(e, null, url, appKey, method, params);
    }
    ...
    private static void logCommError(Exception e, HttpURLConnection conn,
        ...
        Map<String, String> params = ZhimaLogger.parseParam(content);
        ZhimaLogger._logCommError(e, conn, null, appKey, method, params);
    }
    ...
    private static void _logCommError(Exception e, HttpURLConnection conn,
        ...
        sb.append("^_^");
        sb.append(ZhimaLogger.getIp());// IP地址
        sb.append("^_^");
        sb.append(ZhimaLogger.osName);// 操作系统
        sb.append("^_^");
        ...
        ZhimaLogger.clog.error(sb.toString());
    }
    ...
    public static void logBizError(String rsp) {
        ...
        sb.append("^_^");
        sb.append(rsp);
        ZhimaLogger.blog.error(sb.toString());
    }
    ...
    public static void logErrorScene(Map<String, Object> rt,
            ZhimaResponse tRsp, String appSecret) {
        if (!ZhimaLogger.needEnableLogger) {
            return;
        }
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        ...
        sb.append("^_^");
        sb.append(ZhimaLogger.ip);
        sb.append("^_^");
        sb.append(ZhimaLogger.osName);
        sb.append("^_^");
        sb.append(df.format(new Date()));
        sb.append("^_^");
        sb.append("ProtocalParams:");
        ZhimaLogger.appendLog((ZhimaHashMap) rt.get("protocalParams"), sb);
        sb.append("^_^");
        sb.append("ApplicationParams:");
        ZhimaLogger.appendLog((ZhimaHashMap) rt.get("textParams"), sb);
        sb.append("^_^");
        sb.append("Body:");
