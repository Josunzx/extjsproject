...
public abstract class ZhimaUtils {
    ...
    public static String getMimeType(byte[] bytes) {
        String suffix = ZhimaUtils.getFileSuffix(bytes);
        String mimeType;
     ...
     */
    public static <T extends ZhimaResponse> T parseResponse(String json,
            Class<T> clazz) throws ZhimaApiException {
    ...
    public static String getLocalNetWorkIp() {
        if (ZhimaUtils.localIp != null) {
            return ZhimaUtils.localIp;
        }
        try {
            ...
            if (ip != null) {
                ZhimaUtils.localIp = ip.getHostAddress();
            } else {
                ZhimaUtils.localIp = "127.0.0.1";
            }
        } catch (Exception e) {
            ZhimaUtils.localIp = "127.0.0.1";
        }
