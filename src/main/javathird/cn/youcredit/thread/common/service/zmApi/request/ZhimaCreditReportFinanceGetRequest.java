...
import cn.youcredit.thread.common.service.zmApi.response.ZhimaCreditReportFinanceGetResponse;

/**
 * ALIPAY API: zhima.credit.report.finance.get request
 * 
 * @author auto create
 * @since 1.0, 2017-05-03 09:55:56
 */
public class ZhimaCreditReportFinanceGetRequest implements ZhimaRequest<ZhimaCreditReportFinanceGetResponse> {
...
SN000      其他
	...
	* 商户传入的业务流水号。此字段由商户生成，需确保唯一性，用于定位每一次请求，后续按此流水进行对帐。生成规则: 固定30位数字串，前17位为精确到毫秒的时间yyyyMMddHHmmssSSS，后13位为自增数字
	...
	public Class<ZhimaCreditReportFinanceGetResponse> getResponseClass() {
		return ZhimaCreditReportFinanceGetResponse.class;
	}
}
