...
public class AESUtil {
     ...
     * @throws Exception
     */
    public static String encrypt(String data, String aesBase64Key,
            String charset) throws Exception {
        // AES加密
        Cipher cipher = AESUtil.initCipher(aesBase64Key, Cipher.ENCRYPT_MODE);
    ...
    public static void encryptFile(File sourceFile, File targetFile,
            String aesBase64Key, String charset) throws Exception {
        InputStream inputStream = null;
        OutputStream outputStream = null;
        try {
            inputStream = new FileInputStream(sourceFile);
            outputStream = new FileOutputStream(targetFile);
            Cipher cipher = AESUtil.initCipher(aesBase64Key,
                Cipher.ENCRYPT_MODE);
     ...
     *         解密异常
     */
    public static String decrypt(String encryptedData, String aesBase64Key,
            String charset) throws Exception {
        // AES加密
        Cipher cipher = AESUtil.initCipher(aesBase64Key, Cipher.DECRYPT_MODE);

        byte[] bytOut = cipher.doFinal(Base64Util
            .base64ToByteArray(encryptedData));
     ...
     * @throws Exception
     */
    public static String decryptResponse(String fullResponse, String aesKey,
            String charset) throws Exception {
        String decryptedRsp = null;
        Map rootJson = AESUtil.parseResponseMap(fullResponse);
        ...
        if (((Boolean) rootJson.get("encrypted")).booleanValue()) {
            decryptedRsp = AESUtil.decrypt(decryptedRsp, aesKey, charset);
        }
        return decryptedRsp;
    }
     ...
     *         解密异常
     */
    public static void decryptToFile(File file, InputStream encryptedData,
            String aesBase64Key) throws Exception {
     ...
     * @throws Exception
     */
    public static Cipher initCipher(String aesBase64Key, int mode)
            throws Exception {
        SecretKeySpec skeySpec = AESUtil.getSecretKeySpec(aesBase64Key);
        Cipher cipher = Cipher.getInstance(AESUtil.AES_ALGORITHM_PADDING);
     ...
     */
    public static SecretKeySpec getSecretKeySpec(String aesBase64Key) {
        SecretKeySpec skeySpec = new SecretKeySpec(
            Base64Util.base64ToByteArray(aesBase64Key), AESUtil.AES_ALGORITHM);
        return skeySpec;
    }
    ...
    public static String initKey() throws Exception {
        //实例化
        KeyGenerator kgen = KeyGenerator.getInstance(AESUtil.AES_ALGORITHM);
        //设置密钥长度
