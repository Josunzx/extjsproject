...
import cn.youcredit.thread.common.service.zmApi.response.ZhimaCreditEpRiskIndexGetResponse;

/**
 * ALIPAY API: zhima.credit.ep.risk.index.get request
 * 
 * @author auto create
 * @since 1.0, 2017-04-12 17:33:35
 */
public class ZhimaCreditEpRiskIndexGetRequest implements ZhimaRequest<ZhimaCreditEpRiskIndexGetResponse> {
	...
	* -1： 所有风险指数
	...
	public Class<ZhimaCreditEpRiskIndexGetResponse> getResponseClass() {
		return ZhimaCreditEpRiskIndexGetResponse.class;
	}
}
