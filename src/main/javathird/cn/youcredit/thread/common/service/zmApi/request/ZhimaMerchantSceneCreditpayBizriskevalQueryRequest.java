...
import cn.youcredit.thread.common.service.zmApi.response.ZhimaMerchantSceneCreditpayBizriskevalQueryResponse;

/**
 * ALIPAY API: zhima.merchant.scene.creditpay.bizriskeval.query request
 * 
 * @author auto create
 * @since 1.0, 2017-07-20 22:17:50
 */
public class ZhimaMerchantSceneCreditpayBizriskevalQueryRequest implements ZhimaRequest<ZhimaMerchantSceneCreditpayBizriskevalQueryResponse> {
	...
	* 支付宝uid
	...
	public Class<ZhimaMerchantSceneCreditpayBizriskevalQueryResponse> getResponseClass() {
		return ZhimaMerchantSceneCreditpayBizriskevalQueryResponse.class;
	}
}
