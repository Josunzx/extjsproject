...
import cn.youcredit.thread.common.service.zmApi.FileItem;
...
public abstract class WebUtils {
    ...
    public static String doPost(String url, Map<String, String> params,
        ...
        return WebUtils.doPost(url, params, WebUtils.DEFAULT_CHARSET,
    ...
    public static String doPost(String url, Map<String, String> params,
        ...
        return WebUtils
            .doPost(url, ctype, content, connectTimeout, readTimeout);
    }
    ...
    public static String doPost(String url, String ctype, byte[] content,
        ...
        try {
            try {
                conn = WebUtils.getConnection(new URL(url),
                    WebUtils.METHOD_POST, ctype);
                conn.setConnectTimeout(connectTimeout);
                conn.setReadTimeout(readTimeout);
            } catch (IOException e) {
                Map<String, String> map = WebUtils.getParamsFromUrl(url);
                ZhimaLogger.logCommError(e, url, map.get("app_id"),
            ...
            try {
                ...
                Map<String, String> map = WebUtils.getParamsFromUrl(url);
                ZhimaLogger.logCommError(e, conn, map.get("app_id"),
                    map.get("method"), content);
                throw e;
            }
    ...
    public static String doPost(String url, Map<String, String> params,
        ...
        if (fileParams == null || fileParams.isEmpty()) {
            ...
            return WebUtils.doPost(url, params, fileParams,
                WebUtils.DEFAULT_CHARSET, connectTimeout, readTimeout);
        }
    }
    ...
    public static String doPost(String url, Map<String, String> params,
            ...
            int connectTimeout, int readTimeout) throws IOException {
        if (fileParams == null || fileParams.isEmpty()) {
            return WebUtils.doPost(url, params, charset, connectTimeout,
                readTimeout);
        }
        ...
        try {
            try {
                ...
                Map<String, String> map = WebUtils.getParamsFromUrl(url);
                ZhimaLogger.logCommError(e, url, map.get("app_key"),
            ...
            try {
                ...
                for (Entry<String, String> textEntry : textEntrySet) {
                    byte[] textBytes = WebUtils.getTextEntry(
                ...
                for (Entry<String, FileItem> fileEntry : fileEntrySet) {
                    ...
                    byte[] fileBytes = WebUtils.getFileEntry(
                        fileEntry.getKey(), fileItem.getFileName(),
                ...
                Map<String, String> map = WebUtils.getParamsFromUrl(url);
                ZhimaLogger.logCommError(e, conn, map.get("app_key"),
                    map.get("method"), params);
                throw e;
            }
    ...
    public static String doGet(String url, Map<String, String> params)
            throws IOException {
        return WebUtils.doGet(url, params, WebUtils.DEFAULT_CHARSET);
    }
    ...
    public static String doGet(String url, Map<String, String> params,
        ...
        try {
            ...
            String query = WebUtils.buildQuery(params, charset);
            try {
                conn = WebUtils.getConnection(WebUtils.buildGetUrl(url, query),
                    WebUtils.METHOD_GET, ctype);
            } catch (IOException e) {
                Map<String, String> map = WebUtils.getParamsFromUrl(url);
                ZhimaLogger.logCommError(e, url, map.get("app_key"),
                    map.get("method"), params);
    ...
    public static String buildQuery(Map<String, String> params, String charset)
            throws IOException {
        return WebUtils.buildQuery(params, true, charset);
    }

    public static String buildQueryWithoutEncode(Map<String, String> params)
            throws IOException {
        return WebUtils.buildQuery(params, false, null);
    }

    private static String buildQuery(Map<String, String> params,
            boolean needEncode, String charset) throws IOException {
    ...
    private static String getResponseCharset(String ctype) {
        String charset = WebUtils.DEFAULT_CHARSET;
    ...
    public static String decode(String value) {
        return WebUtils.decode(value, WebUtils.DEFAULT_CHARSET);
    }
    ...
    public static String encode(String value) {
        return WebUtils.encode(value, WebUtils.DEFAULT_CHARSET);
    }
    ...
    private static Map<String, String> getParamsFromUrl(String url) {
        ...
        if (url != null && url.indexOf('?') != -1) {
            map = WebUtils.splitUrlQuery(url.substring(url.indexOf('?') + 1));
        }
        if (map == null) {
