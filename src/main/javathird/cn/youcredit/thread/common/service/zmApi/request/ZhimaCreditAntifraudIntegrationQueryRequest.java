...
import cn.youcredit.thread.common.service.zmApi.response.ZhimaCreditAntifraudIntegrationQueryResponse;
 ...
 */
public class ZhimaCreditAntifraudIntegrationQueryRequest implements ZhimaRequest<ZhimaCreditAntifraudIntegrationQueryResponse> {
	...
	* wifi的物理地址。支持格式如下：xx:xx:xx:xx:xx:xx，xx-xx-xx-xx-xx-xx，xxxxxxxxxxxx，x取值范围[0,9]之间的整数及A，B，C，D，E，F
	...
	public Class<ZhimaCreditAntifraudIntegrationQueryResponse> getResponseClass() {
		return ZhimaCreditAntifraudIntegrationQueryResponse.class;
	}
}
