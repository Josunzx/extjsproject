...
import cn.youcredit.thread.common.service.zmApi.response.ZhimaMerchantEnterpriseApplyResponse;
...
请通过zhima.merchant.image.upload上传文件
	...
	* 为用户提供服务的网站，如有请填写 支付宝服务窗，微信公众号，网站地址，应用名称必须是4选1
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("auth_letter_url", this.authLetterUrl);
		...
		txtParams.put("merchant_type", this.merchantType);
